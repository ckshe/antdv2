...
export default {
  ...
  'menu.recharge.orderdetails': '订单详情',
  'menu.recharge.strikebalance': '冲账列表',
  'menu.recharge.rechargeform': '冲账充值',
  'menu.recharge.review': '冲账审核',
  'menu.recharge.billcheck': '账单核对',
  'menu.recharge.orderrecord': '订单操作记录',

  'menu.diamond': 'M钻管理',
  'menu.diamond.account': 'M钻流水',
  'menu.diamond.consume': 'M钻消费',
  'menu.diamond.deductlist': '专家扣钻记录',
  'menu.diamond.statistics': '收益日报表',
  
  'menu.recommend': '推介管理',
  'menu.recommend.recommendlist': '推介列表',
